...
import { ArrowLeftIcon, MagnifyingGlassIcon, ArrowDownCircleIcon } from '@heroicons/react/24/outline';
    ...
    <div className="w-full h-screen flex flex-col bg-gray-900">
      <div className="p-3 bg-gray-800 text-white border-b border-gray-700">
        <div className="flex items-center gap-2">
          <Link href={returnUrl} className="text-gray-300 hover:text-white">
